...
from veda._utils.rlp import (
    validate_imported_block_unchanged,
)
from veda._warnings import (
...
from veda.db.chain import (
    ChainDB,
)
from veda.db.header import (
    HeaderDB,
)
from veda.estimators import (
    get_gas_estimator,
)
...
from veda.vm.chain_context import (
    ChainContext,
)
...
class BaseChain(Configurable, ChainAPI):
    ...
    def validate_chain_extension(self, headers: Tuple[BlockHeaderAPI, ...]) -> None:
        for index, header in enumerate(headers):
            ...
            # TODO: VEDA/ we don't have other extension here currently.
            pass

class Chain(BaseChain):
    logger = logging.getLogger("veda.chain.chain.Chain")
