...
class BaseVedaError(Exception):
    """
    The base class for all Veda errors.
    """
    pass


class AmbigiousFileSystem(BaseVedaError):
    """
...
class MissingPath(BaseVedaError):
    """
...
class SyncRequestAlreadyProcessed(BaseVedaError):
    """
...
class OversizeObject(BaseVedaError):
    """
