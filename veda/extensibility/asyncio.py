...
from veda._utils.asyncio_utils import create_task, wait_first

from veda._utils.logging import child_process_logging
from veda._utils.profiling import profiler
from veda._utils.timer import Timer
            ...
            async with background_asyncio_service(event_bus_service) as eventbus_manager:
                ...
                try:
                    ...
                    if self._boot_info.profile:
                        ...
                        # See https://github.com/ethereum/veda/issues/1711 for more.
                        try:
                            await wait_first(
                                tasks,
