...
from veda.events import (
    AvailableEndpointsUpdated,
    EventBusConnected,
)
from veda.extensibility.component import (
...
class ComponentManager(Service):
    ...
    logger = logging.getLogger('veda.extensibility.component_manager.ComponentManager')
    ...
    async def run(self) -> None:
        connection_config = ConnectionConfig.from_name(
            MAIN_EVENTBUS_ENDPOINT,
            self._boot_info.veda_config.ipc_dir
        )
