...
from veda.vm.code_stream import (
    CodeStream,
)
from veda.vm.gas_meter import (
    GasMeter,
)
from veda.vm.logic.invalid import (
    InvalidOpcode,
)
from veda.vm.memory import (
    Memory,
)
from veda.vm.message import (
    Message,
)
from veda.vm.stack import (
    Stack,
)
...
class BaseComputation(ComputationAPI, Configurable):
    ...
    The base class for all execution computations.
      ...
      .. note::
        ...
        Each :class:`~veda.vm.computation.BaseComputation` class must be configured with:
    ...
    logger = get_extended_debug_logger("veda.vm.computation.BaseComputation")
