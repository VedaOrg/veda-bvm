...
from . import logic as veda_logic
from .storage import sstore_eip3529
...
VEDA_OPCODES: Dict[int, OpcodeAPI] = {
    #
    # Arithmetic
    #
    ...
    # TODO: VEDA/ consider delete this.
    opcode_values.BALANCE: as_opcode(
        gas_cost=constants.GAS_NULL,
        logic_fn=veda_logic.balance_eip2929,
    ...
    opcode_values.SLOAD: as_opcode(
        gas_cost=constants.GAS_NULL,
        logic_fn=veda_logic.sload_eip2929,
        mnemonic=mnemonics.SLOAD,
    ),
    opcode_values.SSTORE: as_opcode(
        gas_cost=constants.GAS_NULL,
        logic_fn=ensure_no_static(sstore_eip3529),
    ...
    # System
    #
    opcode_values.CREATE: veda_logic.Create.configure(
        __name__="CreateEIP3860",
        mnemonic=mnemonics.CREATE,
        gas_cost=constants.GAS_CREATE,
    )(),
    opcode_values.CREATE2: veda_logic.Create2.configure(
        __name__="Create2EIP3860",
        mnemonic=mnemonics.CREATE2,
        gas_cost=constants.GAS_CREATE,
    )(),
    opcode_values.STATICCALL: veda_logic.StaticCallVeda.configure(
        __name__="opcode:STATICCALL",
        mnemonic=mnemonics.STATICCALL,
        gas_cost=constants.GAS_NULL,
    )(),
    opcode_values.CALL: veda_logic.CallVeda.configure(
        __name__="opcode:CALL",
        mnemonic=mnemonics.CALL,
        gas_cost=constants.GAS_NULL,
    )(),
    opcode_values.CALLCODE: veda_logic.CallCodeVeda.configure(
    ...
    opcode_values.SELFDESTRUCT: as_opcode(
        logic_fn=ensure_no_static(veda_logic.selfdestruct),
        mnemonic=mnemonics.SELFDESTRUCT,
        gas_cost=GAS_SELFDESTRUCT,
    ),

    opcode_values.DELEGATECALL: veda_logic.DelegateCallVeda.configure(
